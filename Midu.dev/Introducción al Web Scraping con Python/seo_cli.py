...
if response.status_code == 200:
  ...
  if titulo_pagina:
    print(f"\033[44mEl título de la página es: {titulo_pagina}\033[0m")
  ...
  if not titulos:
    print("❌  No se encontraron títulos h1 en la página")
  elif len(titulos) > 1:
    print("❌  Hay más de un título h1 en la página")
    for titulo in titulos:
      print(titulo)
  else:
    print("✅  Hay un título h1 en la página")
